...
Clone this repo for your new project. Start dropping your js source into the src/ directory. Feel free to replace the html file under build/ if you want and add whatever CSS or other resources you want. Run bin/build.sh to compile the JS correctly (requires Node). You can then either drop the static resources in the build/ directory whereever you want or run bin/serve.sh to spin up a simple web server.
